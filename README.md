...
This is a static website. Open `index.html` directly in a browser, or serve the repository with any local static HTTP server so that links and assets behave like they do when deployed. For example:
